  ...
  const mockParlayLegs: ParlayLeg[] = [
    {
      ...
      game: {
        ...
        homeTeam: { id: 'team1', name: 'Kansas City Chiefs', abbreviation: 'KC', logo: '' },
        awayTeam: { id: 'team2', name: 'Buffalo Bills', abbreviation: 'BUF', logo: '' },
        status: 'scheduled',
    ...
    },
    {
      ...
      game: {
        id: 'game2',
        date: new Date().toISOString(),
        homeTeam: { id: 'team3', name: 'San Francisco 49ers', abbreviation: 'SF', logo: '' },
        awayTeam: { id: 'team4', name: 'Dallas Cowboys', abbreviation: 'DAL', logo: '' },
        status: 'scheduled',
    ...
    },
    {
      ...
      game: {
        id: 'game3',
        date: new Date().toISOString(),
        homeTeam: { id: 'team5', name: 'Green Bay Packers', abbreviation: 'GB', logo: '' },
        awayTeam: { id: 'team6', name: 'Chicago Bears', abbreviation: 'CHI', logo: '' },
        status: 'scheduled',
        venue: 'Lambeau Field',
      },
      selection: 'away',
